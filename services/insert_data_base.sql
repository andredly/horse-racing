...
INSERT INTO account (login,password, data_register_account,status,balance,email,is_delete) VALUES ('log','pas','10.12.2016','ADMIN',100.0,'a@r.ru',false);
INSERT INTO account (login,password,data_register_account,status,balance,email,is_delete) VALUES ('log1','pas1','10.12.2016','CLIENT',200.0,'2f@r.ru',false);
INSERT INTO account (login,password,data_register_account,status,balance,email,is_delete) VALUES ('log2','pas2','10.12.2016','CLIENT',0,'2f@r.ru',false);
...
INSERT INTO race_card (date_start,date_finish,race_type,racecourse_id) VALUES ('2016.11.08 05:00',NULL ,'1000',1);
INSERT INTO race_card (date_start,date_finish,race_type,racecourse_id) VALUES ('2016.11.08 12:10',NULL ,'1500',1);
INSERT INTO race_card (date_start,date_finish,race_type,racecourse_id) VALUES ('2016.11.08 12:10',NULL ,'1500',1);
INSERT INTO race_card (date_start,date_finish,race_type,racecourse_id) VALUES ('2016.11.06 12:10',NULL ,'1500',1);
...
VALUES (1,'WIN','2016.11.15 04:12',2.6,'UNKNOWN','dred');
INSERT INTO event (race_detail_id,event_type,date_register,coefficient_event,result_event,bookmaker)
VALUES (2,'PLACE2','2016.11.15 04:12',1.6,'UNKNOWN','dred');
INSERT INTO event (race_detail_id,event_type,date_register,coefficient_event,result_event,bookmaker)
VALUES (2,'WIN','2016.11.15 04:04',1.5,'UNKNOWN','dred');
INSERT INTO event (race_detail_id,event_type,date_register,coefficient_event,result_event,bookmaker)
