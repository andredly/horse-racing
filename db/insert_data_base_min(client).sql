...
INSERT INTO account (id,login,password, data_register_account,status,balance,email) VALUES (1,'log','pas','10.12.2016','ADMIN',100.0,'a@r.ru');
INSERT INTO account (id,login,password,data_register_account,status,balance,email) VALUES (2,'log1','pas2','10.12.2016','CLIENT',200.0,'2f@r.ru');
INSERT INTO account (id,login,password,data_register_account,status,balance,email) VALUES (3,'log2','pas3','10.12.2016','BOOKMAKER',10.0,'w@r.ru');
INSERT INTO account (id,login,password,data_register_account,status,balance,email) VALUES (4,'log3','pas4','10.12.2016','CLIENT',20.0,'j@r.ru');
INSERT INTO account (id,login,password,data_register_account,status,balance,email) VALUES (5,'log4','pas5','10.12.2016','CLIENT',55.0,'l@r.ru');
INSERT INTO account (id,login,password,data_register_account,status,balance,email) VALUES (6,'log5','pas6','10.12.2016','CLIENT',45.0,'1@r.ru');
...
INSERT INTO race_card (date_start,date_finish,race_type,racecourse_id) VALUES ('2016.11.04','2016.10.17','1600',2);
INSERT INTO race_card (date_start,date_finish,race_type,racecourse_id) VALUES ('2016.11.05','2016.10.17','1600',3);
INSERT INTO race_card (date_start,date_finish,race_type,racecourse_id) VALUES ('2016.11.01','2016.10.17','1600',3);
...
INSERT INTO event (race_detail_id,event_type,date_register,coefficient_event,result_event,bookmaker)
VALUES (7,'win','2016.10.17 20:12',3.6,'qqq' ,'dred');
INSERT INTO event (race_detail_id,event_type,date_register,coefficient_event,result_event,bookmaker)
VALUES (8,'win','2016.10.17 20:12',0.7,'qqq','dred');
INSERT INTO event (race_detail_id,event_type,date_register,coefficient_event,result_event,bookmaker)
VALUES (9,'win','2016.10.17 20:12',2.8,'qqq' ,'dred');
INSERT INTO event (race_detail_id,event_type,date_register,coefficient_event,result_event,bookmaker)
VALUES (10,'win','2016.10.17 20:12',1.7,'qqq','dred');
INSERT INTO event (race_detail_id,event_type,date_register,coefficient_event,result_event,bookmaker)
VALUES (11,'win','2016.10.17 20:12',2.6,'qqq','dred');
INSERT INTO event (race_detail_id,event_type,date_register,coefficient_event,result_event,bookmaker)
VALUES (12,'win','2016.10.17 20:12',2.6,'qqq' ,'dred');
INSERT INTO event (race_detail_id,event_type,date_register,coefficient_event,result_event,bookmaker)
VALUES (13,'win','2016.10.17 20:12',2.6,'qqq' ,'dred');
INSERT INTO event (race_detail_id,event_type,date_register,coefficient_event,result_event,bookmaker)
VALUES (14,'win','2016.10.17 20:12',2.6,'qqq' ,'dred');
INSERT INTO event (race_detail_id,event_type,date_register,coefficient_event,result_event,bookmaker)
VALUES (3,'place','2016.10.17 20:12',1.6,'qqq', 'dred1');
INSERT INTO event (race_detail_id,event_type,date_register,coefficient_event,result_event,bookmaker)
VALUES (4,'place','2016.10.17 20:12',2.6,'qqq' ,'dred1');
INSERT INTO event (race_detail_id,event_type,date_register,coefficient_event,result_event,bookmaker)
VALUES (5,'place','2016.10.17 20:12',2.0,'qqq','dred1');
INSERT INTO event (race_detail_id,event_type,date_register,coefficient_event,result_event,bookmaker)
VALUES (6,'place','2016.10.17 20:12',3.6,'qqq', 'dred1');
INSERT INTO event (race_detail_id,event_type,date_register,coefficient_event,result_event,bookmaker)
